...
const Welcome = (props:WelcomeProps) => {
    ...
    const animate:boolean = useSelector((state: RootState) => state.animate.value)
    const shake:boolean = useSelector((state: RootState) => state.shake.value)
    ...
    return (
        ...
        <div className="content">
            ...
            <svg className={loggedIn ?" spotify move noShadow" : animate ? "spotify move" : "spotify"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">

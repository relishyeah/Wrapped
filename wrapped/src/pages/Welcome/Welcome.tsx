...
const Welcome = (props:WelcomeProps) => {
    ...
    const topClass = () =>{
        return props.loggedIn ? "box-top open noShadow" :
        props.animate ? "box-top open" : props.shake ?"box-top shake": "box-top"
    }
    ...
    return (
        ...
        <div className="content">
            ...
            <div className="present">
                ...
                <svg className={props.loggedIn ?"box-bottom noShadow" : "box-bottom"}
            ...
            <svg className={props.loggedIn ?" spotify move noShadow" : props.animate ? "spotify move" : "spotify"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            ...
            {!props.token && <div className="tagline">
                Unwrap your listening, year by year
            </div>}
            

           {!props.token && <a href={authorize()} className='logIn'>
                    See yours
            </a>  }
